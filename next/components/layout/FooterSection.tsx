                    ...
                    >
                      ...
                      <div>
                        ...
                        <a
                          href="tel:+213560409193"
                          onClick={() => trackPhoneCall("0560409193")}
                          className="flex w-full items-center justify-center gap-2.5 h-12 rounded-2xl bg-[#0a1628] text-white font-bold text-sm hover:bg-[#0d1f35] transition-colors shadow-lg"
                        >
